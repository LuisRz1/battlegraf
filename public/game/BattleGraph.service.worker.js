...
/** @type {string} */
const CACHE_VERSION = '20260828|v6-rutas-aleatorias';
/** @type {string} */
const CACHE_PREFIX = 'BattleGraph-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'BattleGraph.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["BattleGraph.html","BattleGraph.js","BattleGraph.offline.html","BattleGraph.icon.png","BattleGraph.apple-touch-icon.png","BattleGraph.audio.worklet.js","BattleGraph.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["BattleGraph.wasm","BattleGraph.pck"];
