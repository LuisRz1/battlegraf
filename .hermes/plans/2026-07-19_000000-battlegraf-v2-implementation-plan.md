# BattleGraph v2 — Plan de Implementacion Completo

> **For Hermes:** Usa subagent-driven-development para ejecutar este plan tarea por tarea.

**Goal:** Construir la plataforma escolar BattleGraph: backend API (FastAPI + Clean Architecture), app mobile (Flutter retro Balatro-like), motor de grafos, sistema de batallas por turnos, generacion de preguntas con IA, jerarquia de roles, y onboarding de colegios.
