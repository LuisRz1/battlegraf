...
function PrototypeModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    >
      <section
        aria-label="Demo jugable de BattleGraf"
        aria-modal="true"
...
const faqs = [
  {
    question: "¿BattleGraf reemplaza las clases o las evaluaciones?",
    answer:
  ...
  return (
    <main ref={mainRef}>
      ...
      <header className={`site-header ${scrolled ? "is-scrolled" : ""}`}>
        <a aria-label="BattleGraf, inicio" className="brand" href="#inicio">
          <span className="brand-sigil"><i /><i /><i /></span>
          <strong>BATTLE<span>GRAF</span></strong>
        </a>
      ...
      <section className="intel-strip" aria-label="Datos clave de BattleGraf">
      ...
      <footer>
        <a aria-label="BattleGraf, volver al inicio" className="brand" href="#inicio">
          <span className="brand-sigil"><i /><i /><i /></span>
          <strong>BATTLE<span>GRAF</span></strong>
        </a>
